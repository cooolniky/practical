                ...
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                        ...
                        @if(in_array("master_manage",$userPermission))
                            <li class="parent {{$masterManagementTab ?? ''}}" title="Master Managemet"><a href="#"><i
                        ...
                        <li title="profile" class="{{$profileTab ?? ''}}"><a href="{{url('/user/profile')}}"><i
                                        class="icon mdi mdi-face"></i></i><span>{{trans('app.my_profile')}}</span></a>
                        </li>
                        <li title="Change Password" class="{{$changePasswordTab ?? ''}}"><a
